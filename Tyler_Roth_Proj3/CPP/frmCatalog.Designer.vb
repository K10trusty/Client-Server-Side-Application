...
Partial Class frmCatalog
    ...
    Private Sub InitializeComponent()
        ...
        'COURSE_IDComboBox
        '
        Me.COURSE_IDComboBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
        ...
        Me.CPPCOURSESBindingSource.DataSource = Me.CPPDataSet
        '
        'CPPDataSet
        '
        ...
        'PROF_IDComboBox
        '
        Me.PROF_IDComboBox.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList
    ...
    Friend WithEvents CPPDataSet As CPPDataSet
    Friend WithEvents CPPCATALOGBindingSource As BindingSource
    Friend WithEvents CPP_CATALOGTableAdapter As CPPDataSetTableAdapters.CPP_CATALOGTableAdapter
    Friend WithEvents CPPCOURSESBindingSource As BindingSource
    Friend WithEvents CPP_COURSESTableAdapter As CPPDataSetTableAdapters.CPP_COURSESTableAdapter
End Class
